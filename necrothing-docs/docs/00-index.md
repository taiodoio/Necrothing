# NECROTHING Documentation Index

Versione: `v0.1`

## Product

- [Product Vision](./product/01-product-vision.md)
- [Design Principles](./product/02-design-principles.md)

## Game Design

- [Game Design Document](./game-design/01-game-design-document.md)
...
- [UX Structure](./ux-ui/01-ux-structure.md)
...
- [Feature: Burial Flow](../specs/features/001-burial-flow.md)
- [Service: NotificationService](../specs/services/notification-service.md)
- [Data Model: Core Entities](../specs/data-model/core-entities.md)
...
- [Create Feature Prompt](../prompts/create-feature.md)
